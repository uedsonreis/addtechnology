...
public class Teste {
	...
	public static void main(final String[] args) {
		...
		String DIR = "/Users/uedsonreis/Documents/Projetos/ontoKBase/ontologyBase/";
		String URL = "file:";
		OntModel newM = null;

		try {
			ModelMaker maker = ModelFactory.createFileModelMaker(DIR);
			Model base       = maker.createModel("Universidade.owl", false);
		...
		String SOURCE = URL + DIR + "Universidade.owl";
		String camNS = SOURCE + "#";
		...
		OntClass concept = newM.getOntClass(uri);
